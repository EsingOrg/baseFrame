...
<body>
	...
	<div class="systemUser">
		<div class="r_main clearfix ">
			<!--文本框 -->
			<div class="main_title">查看天息记录</div>
			<!--文本框 --END-->
			<!-- 搜索框 -->
			<form action="visitLiveGoldAccrualRecord.do" method="post"
				id="searchBox">
				<input type="hidden" name="userId" value="${req.userId }"/>
				<div class="main_con">
					<div class="admin_input clearfix">
						<p style="margin-top: 3px;">
							用户名：${loginName }  <input type="hidden" name="loginName" value="${loginName }"/>
						</p>
						<p style="margin-top: 3px;">
						...
						<p class="lo_btn">
							<input type="submit" class="search" value="搜索" />
							 <input	name="input" type="button" class="export ml10" value="导出" onclick="exportData('searchBox','exportLiveGoldDayRecord.do')"/>
						</p>
			...
			<div class="main_con">
				<div class="menu_bd clearfix" id="todaytCont">
					...
					<div style="margin-top: 25px;" id="pageId">
						<dim:page url="visitLiveGoldAccrualRecord.do" totalCount="${pageList.data.pageResult.recordCount }" formId="searchBox" showPages="${pageList.data.pageResult.pageSize }"
