...
<!---------------右边内容开始--------------->
      <div class="r_main clearfix">
		...
		<div class="main_con">
            ...
            <div class="initialorder clearfix orderDet" id="PERSONAL_CANCEL_NODE">
             <script id="PERSONAL_CANCEL_NODE_TEMP" type="text/x-jquery-tmpl">
