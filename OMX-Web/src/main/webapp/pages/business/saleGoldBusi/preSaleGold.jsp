 ...
 <body>
	<div >				
	   <div class="r_main clearfix ">
		 <div class="main_title">预卖订单</div>
		 <!--搜索表框  -->
		 <form id="form">
          <div class="main_con">
	         <div class="admin_input clearfix">
	          <p>预卖单号：<input type="text" name="bookNo" class="yhgl_input"  maxlength="20"/></p>
			  ...
			  <p>角色：<dim:select name="userType" enumType="UserType" exclude="SYS" headName="全部" headValue=""></dim:select></p>
			  <p>预卖金价：
	          ...
	          <p class="lo_btn">
                 ...
                 <shiro:hasPermission name="YWGL_MJYW_YMMDD_SC">
		 ...
		 <div class="main_con">
		  ...
		  <div class="mt10" style="display:none;">
          	<p class="fl">预卖克重总计：<span class="yellow f24" id="totalWeight"></span>克</p>
          	<p class="ml100 fl">预卖金额总计：<span class="yellow f24" id="totalAmount"></span>元</p>
          </div> 
		  <div id="pageTag"></div>  
		 </div>
		</div>
    ...
    //分页跳转回调
 	function backFunc(data){
	   ...
	   DMGold.PageTag.init({"divId":"pageTag","formId":"form","curPage":data.pageResult.pageIndex,"totalCount":data.pageResult.recordCount,
			          "pageCount":data.pageResult.pageTotal,"url":"preSaleGoldAjax.do","toPageCallBack":backFunc});
 	}
 	//查询数据
 	function search(){
 		DMGold.ajax({"formId":"form","serialize":true,"url":"preSaleGoldAjax.do","success":backFunc});
 	}
 	/**
 	显示按时间段删除输入框
 	*/
 	...
 	function thSubmit(){
 		...
 		dm.confirm("是否删除？",{
               ...
               callback:function(){	//按确定的执行的函数			 
            	   DMGold.ajax({"formId":'delForm',"serialize":true,"url":"delSaleGoldAjax.do","success":function(data){
						//显示提示信息
						if("000000"==data.code){
