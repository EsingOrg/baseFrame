...
<html>
  ...
  <body>
	...
	<div id="popCon" class="dialog" style="width:600px;margin: -260px 0 0 -400px">
		  <div class="clearfix"> 
		  <div class="title"><a id="closeBtn" href="javascript:;" onClick="$.tbox.close()" class="out"></a>新增买金处理</div>
	<div class="me_con">
	<form id="publicForm" action="purcGoldDealSave.do" method="post" style="margin-top: 30px;">
  ...
  function changeStatus(deal,undeal){
  		 dm.confirm("确定处理买金:<label style=\"color: red;\"> "+deal+"</label> 克"+
