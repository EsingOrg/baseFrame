...
<body>
	<div class="systemUser">
		<div class="r_main clearfix ">
			<!-- 搜索框 -->
			<form action="<%=basePath%>finance/getFinanceStoreTradingRecord.do"
				method="post" id="dataForm">
				<input type="hidden" name="userType" value="${transReq.userType }">
				<div class="main_con">
					<div class="admin_input clearfix">
						<p>
							用户名： <input type="text" name="shopName" class="yhgl_input"
								value="${transReq.shopName}" maxlength="20" />
						</p>
						<p>
							类型： 
							<dim:select name="type" enumType="TransType" headName="全部" headValue="" exclude="BORROW_MGMT,SAVE,TAKE,CHANGE,CHANGE_SAVE,CHANGE_TAKE,RECHARGE_REWARD,SAVE_REWARD,BUY_REWARD" cssClass="yhgl_sel"></dim:select>
						</p>
						<p>
						...
						<p class="lo_btn">
							...
							<shiro:hasPermission name="CWGL_JYJL_DPJYJL_DC">
			...
			<div class="main_con">
				...
				<div style="margin-top: 25px;">
					<dim:page url="getFinanceStoreTradingRecord.do" totalCount="${pageList.data.pageResult.recordCount }" formId="dataForm" showPages="${pageList.data.pageResult.pageSize }"
