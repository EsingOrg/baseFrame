...
<div class="dialog">
  <div class="clearfix">
      <div class="title"><a href="javascript:;" onClick="$.tbox.close()" class="out"></a>提现审核确认</div>
      <div class="cotent">
      <form action="<%=basePath %>finance/updateFinancevPeingPass.do" method="post" id="auditing">
         ...
         <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table"> 
          <tr>            
            <td ><textarea name="remark" cols="63" rows="3" class="border" validate="q|leng" leng="1,100" maxlength="100"></textarea></td>
          </tr>
        </table>
      </form>
      </div>
