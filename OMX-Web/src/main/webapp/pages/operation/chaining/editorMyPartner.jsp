...
<html>
 ...
 <body>
	...
	<div class="me_con">
	<form id="publicForm" action="<%=basePath %>chaining/editorMyPartner.do?type=${type}" method="post" enctype="multipart/form-data">
         ...
         <c:if test="${type=='modify'}">
       	 ...
       	 <c:if test="${type=='add'}">
                ...
                <li>
                    ...
                    <div class="info">
                    <input type="text" value="${pageList.data.title}" class="yhgl_input w300"  validate="q"  name="title" id="title"/>
                    </div>                
                </li>
                <li>
