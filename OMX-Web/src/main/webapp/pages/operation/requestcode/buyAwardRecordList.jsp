...
<body>
  ...
  <div class="r_main clearfix">
    ...
    <!-- 搜索表框  -->
    <form id="dataForm" action="buyGoldRecordList.do" method="post" id="dataForm">
    	 ...
    	 <input name="recommendedId"  type="hidden" value="${rs.recommendedId}"/>
          <div class="admin_input clearfix">
	          ...
	          <p class="lo_btn"> 
	            ...
	            <shiro:hasPermission name="YYGL_TGYQM_MJJLJL_DC">
	   		    <input name="input" type="button" class="export ml10" value="导出" onclick="exportData('dataForm','exportBuyGoldAward.do');"/>
	   		    </shiro:hasPermission>
			  </p>
		  </div>
       </div>
	...
	<div class="main_con">
		<div class="">
		  <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_table tc">
		    ...
		    <tr class="title"><td>总计：</td><td></td><td></td>
		    	<td><fmt:formatNumber value="${pageList.data.columnStatResult.totalBuyWeght}" pattern="#0.00"/></td>
	  ...
	  <!-- 分页 -->    
			<dim:page url="buyGoldRecordList.do" totalCount="${pageList.data.pageResult.recordCount }" formId="dataForm" showPages="${pageList.data.pageResult.pageSize }"
