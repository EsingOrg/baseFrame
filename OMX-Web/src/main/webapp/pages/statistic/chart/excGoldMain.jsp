...
<script src="<%=basePath%>js/exporting.js" charset="utf-8"></script>
	<div class="r_main clearfix">
		...
		<!--文本框 -->
		<div class="main_title">换金统计</div>
        <div class="main_con clearfix">
          	<div class="user_con">
                <ul class="user_now clearfix">
                <li><p class="yellow"><span class="f24">${data.data.statResult.personalTotalWeight}</span>克</p><p>个人换金克重</p>
                </li>             
                </ul>
          	</div>
        </div>
		...
		<div class="me_con">
			...
			<div class="part" id="con_one_1">
				<iframe id="iframepage" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" height="100%" id="iframepage" name="iframepage" onLoad="iFrameHeight()" src="excGoldTrend.do?statType=<%=type%>&startTime=<%=startDate%>&endTime=<%=endDate%>"></iframe>
			</div>
		</div>
	</div>
</body> 
