...
<body>
  ...
  <div class="r_main clearfix">
    ...
    <!-- 搜索表框  -->
    <form id="dataForm" action="shopAssetList.do" method="post">
    	<div class="main_con">
          <div class="admin_input clearfix">
	          ...
	          <p>账户总资产： 
			  	<input type="text" validate="amount"  name="minCashAmount" class="yhgl_input" value="${as.minCashAmount}" maxlength="40"/>元-
			  	<input type="text"  validate="amount" name="maxCashAmount" class="yhgl_input" value="${as.maxCashAmount}" maxlength="40"/>元
	          </p>
	          <p>累计赚取利息： 
			  	<input type="text"  validate="amount" name="minInRate" class="yhgl_input" value="${as.minInRate}" maxlength="40"/>元-
			  	<input type="text"  validate="amount" name="maxInRate" class="yhgl_input" value="${as.maxInRate}" maxlength="40"/>元
	          </p>
	          <p>累计提金： 
			  	<input type="text"  validate="weight" name="minTakeWeight" class="yhgl_input" value="${as.minTakeWeight}" maxlength="40"/>克-
			  	<input type="text"  validate="weight" name="maxTakeWeight" class="yhgl_input" value="${as.maxTakeWeight}" maxlength="40"/>克
	          </p>
	          <p>累计买金： 
			  	<input type="text"  validate="weight" name="minBuyWeight" class="yhgl_input" value="${as.minBuyWeight}" maxlength="40"/>克-
			  	<input type="text"  validate="weight" name="maxBuyWeight" class="yhgl_input" value="${as.maxBuyWeight}" maxlength="40"/>克
	          </p>
	          <p>累计卖金： 
			  	<input type="text"  validate="weight" name="minSaleWeight" class="yhgl_input" value="${as.minSaleWeight}" maxlength="40"/>克-
			  	<input type="text"  validate="weight" name="maxSaleWeight" class="yhgl_input" value="${as.maxSaleWeight}" maxlength="40"/>克
	          </p>
	          <p>累计存金： 
			  	<input type="text"  validate="weight" name="minSaveWeight" class="yhgl_input" value="${as.minSaveWeight}" maxlength="40"/>克-
			  	<input type="text"  validate="weight" name="maxSaveWeight" class="yhgl_input" value="${as.maxSaveWeight}" maxlength="40"/>克
	          </p>
	          <p class="lo_btn"> 
	            <input name="input" type="submit" class="search" value="搜索" onclick="if(!dmCheck.check('#dataForm')){return false;}" />
	            <shiro:hasPermission name="TJGL_ZCTJ_DPZCTJ_DC">
	   		    <input name="input" type="button" class="export ml10" value="导出" onclick="exportData('dataForm','exportShopAsset.do');"/>
	   		    </shiro:hasPermission>
			  </p>
		  </div>
       </div>    
	...
	<div class="main_con">
	  ...
	  <div style="margin-top: 25px;" id="pageId">
			<dim:page url="shopAssetList.do" totalCount="${pageList.data.pageResult.recordCount }" formId="dataForm" showPages="${pageList.data.pageResult.pageSize }"
