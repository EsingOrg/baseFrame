	...
	<div class="r_main clearfix">
        ...
        <div class="main_con clearfix">
          	<div class="user_con">
                ...
                <li><p class="yellow"><span class="f24">${data.data.statResult.amount}</span>元</p><p>累计提现金额</p>
                </li> 
                <li><p class="yellow"><span class="f24">${data.data.statResult.count}</span>笔</p><p>累计提现笔数</p>
                </li>               
                </ul>
          	</div>
        </div>
		...
		<div class="me_con">
			...
			<div class="part" id="con_one_1">
				<iframe id="iframepage" marginheight="0" marginwidth="0" frameborder="0" scrolling="no" width="100%" height="100%" id="iframepage" name="iframepage" onLoad="iFrameHeight()" src="withdrawTrend.do?statType=<%=type%>&startTime=<%=startDate%>&endTime=<%=endDate%>"></iframe>
			</div>
		</div>
	</div>
</body> 
